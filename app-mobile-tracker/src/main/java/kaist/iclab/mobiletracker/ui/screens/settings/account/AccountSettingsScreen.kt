package kaist.iclab.mobiletracker.ui.screens.settings.account
...
import kaist.iclab.mobiletracker.ui.components.campaign.CampaignDialog
import kaist.iclab.mobiletracker.ui.components.logout.LogoutDialog
...
fun AccountSettingsScreen(
    ...
    if (showReloadDialog) {
        PopupDialog(
            title = stringResource(R.string.reload_config_dialog_title),
            content = {
                Text(
                    text = stringResource(R.string.reload_config_dialog_message),
                    fontSize = 14.sp,
    ...
    if (showLeaveDialog) {
        PopupDialog(
            title = stringResource(R.string.leave_campaign_dialog_title),
            content = {
                Text(
                    text = stringResource(R.string.leave_campaign_dialog_message),
                    fontSize = 14.sp,
                    color = Color(0xFF6B7280),
                    textAlign = androidx.compose.ui.text.style.TextAlign.Start
                )
    ...
    Box(
        ...
        Column(modifier = Modifier.fillMaxSize()) {
            ...
            Column(
                ...
                // User name
                Text(
                    text = userState.user?.name ?: stringResource(R.string.unknown),
                    fontWeight = FontWeight.Bold,
                ...
                Column(
                    ...
                    InfoRow(
                        ...
                        value = userState.user?.email ?: stringResource(R.string.no_email)
                    )
                }
                ...
                Card(
                    ...
                    CampaignMenuItem(
                        ...
                        description = selectedCampaignName
                            ?: stringResource(R.string.campaign_no_campaign_joined),
                    ...
                    if (selectedCampaignName != null) {
                        ...
                        CampaignMenuItem(
                            title = stringResource(R.string.menu_reload_config),
                            description = stringResource(R.string.menu_reload_config_desc),
                        ...
                        CampaignMenuItem(
                            title = stringResource(R.string.menu_leave_campaign),
                            description = stringResource(R.string.menu_leave_campaign_desc),
