...
class WatchSensorRepositoryImpl(
    ...
    private val storeById: Map<String, SensorStore<out BaseEntity>> = mapOf(
        ...
        Constants.SensorId.IMU to stores.watchIMU,
        Constants.SensorId.GESTURE to stores.watchGesture,
        Constants.SensorId.STRESS to stores.watchStress,
