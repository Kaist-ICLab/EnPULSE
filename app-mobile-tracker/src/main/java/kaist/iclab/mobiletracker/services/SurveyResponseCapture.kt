 ...
 * network-gated cycle as everything else in [kaist.iclab.mobiletracker.services.upload.DataUploadService]
 * — no immediate best-effort flush here, so a submission's upload timing matches every other
 * sensor's.
 */
